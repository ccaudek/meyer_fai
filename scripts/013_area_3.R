# Script name: 013_area_3.R
# Project: project
# Script purpose: AREA 3: Cura formale
...
# Area 2 items names.
item_subscale <- c(
  "FAI_156", "FAI_67", "FAI_176", "FAI_28", "FAI_149", 
  "FAI_35", "FAI_192", "FAI_87", "FAI_143", "FAI_90", "FAI_160", 
  "FAI_69", "FAI_170", "FAI_79", "FAI_24", "FAI_76", "FAI_114", 
  "FAI_74", "FAI_92", "FAI_163")
...
# continuum.
names_kept_items <- c("FAI_87", "FAI_79", "FAI_143", "FAI_192", "FAI_156") 
...
one_factor_model <-  'F =~ FAI_87 + FAI_79 + FAI_143 + FAI_192 + FAI_156'
