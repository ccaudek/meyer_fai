# Script name: 016_area_6.R
# Project: project
# Script purpose: AREA 6: Iperprotezione
...
# Area 2 items names.
item_subscale <- c("FAI_9",   "FAI_153", "FAI_2",  "FAI_137", "FAI_96",  
                   "FAI_165", "FAI_194", "FAI_13",  "FAI_14", "FAI_101", 
                   "FAI_144", "FAI_31", "FAI_151", "FAI_159", "FAI_182", 
                   "FAI_27")
...
names_kept_loc_ind_items <- names(kept_items_2[ca$InScale[[1]]])
...
# continuum.
names_kept_items <- c("FAI_101", "FAI_159", "FAI_137", "FAI_96") 
...
one_factor_model <-  'F =~ FAI_101 + FAI_159 + FAI_137 + FAI_96'
