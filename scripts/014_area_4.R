...
# Project: project
# Script purpose: AREA 3: Fattori intrapsichici
...
# continuum.
names_kept_items <- c("FAI_111", "FAI_104", "FAI_42", "FAI_119", "FAI_93") 
...
one_factor_model <-  'F =~ FAI_111 + FAI_104 + FAI_42 + FAI_119 + FAI_93'
