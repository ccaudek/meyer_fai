...
* Item fit (infit and outfit). Criteria for item fit are considered as within the mean squares range of 0.6-1.4 and standardized fit statistics of +/âˆ’2.0.  If outfit and infit are within these values, they can be considered adequate for measuring the latent construct on an interval-level. 
...
* Person fit is evaluated based on the same criteria with item fit (mean squares range of 0.6-1.4 and standardized fit statistics of +/âˆ’2.0) and number (and percentages) of misfitting persons are reported based on outfit and infit. (and compared to a criterion of <5 percent)
...
for each subscale:
- Is item fit (infit and outfit) within the acceptable range (mean squares 0.6-1.4 and standardized fit statistics within +/âˆ’2.0)?
...
- Do most persons fit the model (<5 percent with mean squares out of the 0.6-1.4 range and standardized fit statistics outside +/âˆ’2.0)?
